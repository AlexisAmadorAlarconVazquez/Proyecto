...
//noinspection SimplifiableIfStatement
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_home) {
                ...
                Toast.makeText(MainActivity.this, getString(R.string.calendar_selected_toast), Toast.LENGTH_SHORT).show();
                return true;
            } else if (itemId == R.id.nav_chat) {
                Toast.makeText(MainActivity.this, getString(R.string.chat_selected_toast), Toast.LENGTH_SHORT).show();
                return true;
